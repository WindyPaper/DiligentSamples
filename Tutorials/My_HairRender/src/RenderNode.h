...
public:
    ...
    RefCntAutoPtr<IBuffer> CreateRawBuffer(const int raw_size, void *pInitialData, const std::string &desc = "");
    RefCntAutoPtr<IBuffer> CreateUndefinedBuffer(const int buffer_size, void *pInitialData, const std::string &desc = "");
